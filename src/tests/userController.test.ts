...
jest.mock('../services/gfsService');
const gfsServiceMock = require('../services/gfsService');
...
describe('user controller', () => {
    ...
    gfsServiceMock.gfsService.deleteItem = jest.fn().mockReturnValue(Promise.resolve({}));
    gfsServiceMock.gfsService.getItem = jest.fn().mockReturnValue(Promise.resolve({}));
